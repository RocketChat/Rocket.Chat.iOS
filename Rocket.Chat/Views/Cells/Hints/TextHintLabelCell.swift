...
//
// NOTE: This is a 'manual' specialization of the generic TextHintLabelCell class
...
// class TextHintLabelCell: TextHintCell<UILabel> { }
//

import UIKit

class TextHintLabelCell: UITableViewCell {
    /*
     The hint's prefix view
     */
    let prefixView: UILabel = tap(UILabel()) {
