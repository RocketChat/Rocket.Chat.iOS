//
//  ThreadUnfollowRequestSpec.swift
//  Rocket.ChatTests
//
...
class ThreadUnfollowRequestSpec: APITestCase {
    func testRequestWithMessageId() {
        let preRequest = ThreadUnfollowRequest(mid: "ByehQjC44FwMeiLbX")
        ...
        XCTAssertEqual(request.url?.path, "/api/v1/chat.unfollowMessage", "path is correct")
