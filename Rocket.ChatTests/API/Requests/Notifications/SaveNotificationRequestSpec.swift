...
class SaveNotificationRequestSpec: APITestCase {
    ...
    func testRequest() {
        ...
        XCTAssertEqual(bodyJson["notifications"]["emailNotifications"].string, notificationPreferences.emailNotifications, "emailNotifications is correct")
        XCTAssertEqual(bodyJson["notifications"]["audioNotifications"].string, notificationPreferences.audioNotifications, "audioNotifications is correct")
        XCTAssertEqual(bodyJson["notifications"]["mobilePushNotifications"].string, notificationPreferences.mobilePushNotifications, "mobilePushNotifications is correct")
        XCTAssertEqual(bodyJson["notifications"]["audioNotificationValue"].string, notificationPreferences.audioNotificationValue, "audioNotificationValue is correct")
